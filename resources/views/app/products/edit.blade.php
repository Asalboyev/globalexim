                ...
                <div class="card border-0 shadow components-section">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-4">
                                    <label class="my-1 me-2" for="catalog_id">Catalog</label>
                                    <select class="form-select" id="catalog_id" name="catalog_id">
                                        <option value="">Open this select menu</option>
                                        @foreach($catalog as $item)
                                            @if(old('catalog'))
                                                <option value="{{ $item->id }}" {{ old('catalog_id') == $item->id ? 'selected' : '' }} >{{ $item->title['ru'] }}</option>
                                            @else
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6 col-sm-6">
                                <div class="mb-3">
                                    <label for="main_img" class="form-label">Image</label>
                                    <input id="main_img" class="form-control" type="file" name="main_img">
                                </div>
                            </div>
                        </div>
