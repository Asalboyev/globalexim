              ...
              <tbody>
                @foreach($applications as $application)
                  ...
                  <tr>
                      ...
                      <td class="fw-bold">{{ $application->name ? $application->name : '--' }}</td>
                      <td>{{ $application->phone_number ? $application->phone_number : '--' }}</td>
                      <td>{{ $application->email }}</td>
                      <td>{{ $application->theme ? $application->theme : '--' }}</td>
                      <td>{{ $application->message ? $application->message : '--' }}</td>
                      <td>{{ date('H:i d.m.Y', strtotime($application->created_at)) }}</td>
                      <td>
