    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                <li class="nav-item">
                    <a href="{{ route('admin') }}" class="nav-link d-flex align-items-center" style="font-weight: 600;font-size: 32px;">
                        Global Exim
                ...
                <li class="nav-item {{ Route::currentRouteName() == 'statistics.index' ? 'active' : '' }}">
