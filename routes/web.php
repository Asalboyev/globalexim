...
Route::group(['prefix' => App\Http\Middleware\LocaleMiddleware::getLocale(), 'middleware' => 'locale'], function(){
    ...
    Route::get('/export', [WebController::class, 'export'])->name('export');
    Route::get('/import', [WebController::class, 'import'])->name('import');
    ...
    Route::post('/send-to-email', [WebController::class, 'send_to_email'])->name('send_to_email');
});
...
//     Artisan::call('make:migration add_columns_in_applications_table');
// });
